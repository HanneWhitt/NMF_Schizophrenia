...
for result_index in range(no_significant_results):
    ...
    results, error_estimate_record = log_reg_with_bootstrap(full_indep_variables, SCZ_Control, coefficient_names,
                                                            save_loc=analysis_data_path, save_name=save_name)

    # bootstrap_error_vs_iterations(error_estimate_record, coefficient_names,
    #                               save_loc=analysis_data_path)
